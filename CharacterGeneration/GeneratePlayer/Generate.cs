...
public class Generate
{
    ...
    private Dictionary<string, int[]> experience = new Dictionary<string, int[]>();
    ...
    private void Experience_Info()
    {
        ...
        {
            string[] parts = line.Split(';');
            // разделять стаж работы на массив int???
        }
    }
    ...
    public Player[] GeneratePlayers()
    {
        ...
        for (int i=0; i < count_people; i++)
        {
            players[i] = new Player() { 
                Body = body_type.ElementAt(rand.Next(0, body_type.Count))
            };
        }
        return players;
    }
